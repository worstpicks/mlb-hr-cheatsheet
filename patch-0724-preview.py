#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-24. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-23.html"
SHEET_DATE = "2026-07-24"

spec = importlib.util.spec_from_file_location("build0724", ROOT / "build-sheet-2026-07-24.py")
...
def update_manifest():
    ...
    if "2026-07-23" in old or (ARCHIVE_PREVIOUS.is_file()):
        old["2026-07-23"] = {
            "date": "2026-07-23",
            "label": "July 23, 2026",
            "href": "archive/2026-07-23.html",
        }
    ordered = [
        {"date": SHEET_DATE, "label": "July 24, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-07-23",
        "2026-07-22",
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Friday, July 24, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
