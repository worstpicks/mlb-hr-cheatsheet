#!/usr/bin/env python3
"""List all Straight of the Day options for 2026-07-20."""
...
g: dict = {"__file__": str(ROOT / "patch-0720-preview.py"), "__name__": "__main__"}
exec(compile(cut + "\n", "patch-0720-preview.py", "exec"), g)
...
print("=" * 110)
print("CURRENT STRAIGHTS ON SHEET (7/20)")
print("=" * 110)
