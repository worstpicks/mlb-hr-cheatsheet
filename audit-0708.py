#!/usr/bin/env python3
"""Quick audit for 2026-07-08 sheet before push."""
...
if 'sheet-date" content="2026-07-08"' not in html:
...
if not (ROOT / "preview" / "data" / "research-2026-07-08.json").exists():
    errors.append("missing preview/data/research-2026-07-08.json")
if not (ROOT / "preview" / "data" / "park-factors-2026-07-08.json").exists():
    errors.append("missing preview/data/park-factors-2026-07-08.json")
...
if manifest["sheets"][0]["date"] != "2026-07-08":
    errors.append("manifest current slate not 2026-07-08")
if not (ROOT / "preview" / "archive" / "2026-07-06.html").exists():
    errors.append("missing archive 2026-07-06.html")

if errors:
    print("FAIL audit-0708:")
    for e in errors:
        print(" ", e)
    raise SystemExit(1)

print(
    f"OK audit-0708 — sheet-date, {EXPECTED_GAMES}/{EXPECTED_GAMES} park headers, "
