#!/usr/bin/env python3
"""Build 2026-06-06 sheet from imported CSVs and user prop list."""
...
DATE = "2026-06-06"
OUT = ROOT / "build-sheet-2026-06-06.py"
...
ALIASES = {
    ...
    "Eugenio Sauarez": "Eugenio Suarez",
    "Pedro Pages": "Pedro Pages",
    "Michael Conforoto": "Michael Conforto",
