#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-27. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-26.html"
SHEET_DATE = "2026-07-27"

spec = importlib.util.spec_from_file_location("build0727", ROOT / "build-sheet-2026-07-27.py")
...
def update_manifest():
    ...
    if "2026-07-26" in old or (ARCHIVE_PREVIOUS.is_file()):
        old["2026-07-26"] = {
            "date": "2026-07-26",
            "label": "July 26, 2026",
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 27, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-07-26",
        "2026-07-25",
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Monday, July 27, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
