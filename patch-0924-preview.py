#!/usr/bin/env python3
"""Patch preview sheet to 2026-09-24. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0924", ROOT / "build-sheet-2026-09-24.py")
...
# Score gates below are percentile-matched to the pre-2026-09-24 scale. The rating
