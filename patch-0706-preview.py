#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-06. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-03.html"
SHEET_DATE = "2026-07-06"

spec = importlib.util.spec_from_file_location("build0706", ROOT / "build-sheet-2026-07-06.py")
...
# 7/6: auto-pick straights from best attack lanes (no manual lock).
straight_names = {straight_o05["name"], straight_o15["name"]}
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 6, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Monday, July 6, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
