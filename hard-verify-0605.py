#!/usr/bin/env python3
"""Hard verify June 5 sheet: duplicates, counts, summary, straights, bums."""
...
title_count = len(re.findall(r'title: "', text)) - 1  # minus sheets manifest noise - rough
...
o05_m = re.search(r'straight-pick-name">([^<]+)</strong>', text)
o15_m = re.search(r'straight-pick-hero--o15.*?straight-pick-name">([^<]+)</strong>', text, re.DOTALL)
if o05_m and o15_m:
    o05_game = re.search(
...
if errors:
    print("FAIL hard-verify-0605:")
    for e in errors:
        print(f"  {e}")
    raise SystemExit(1)

print("OK hard-verify-0605")
