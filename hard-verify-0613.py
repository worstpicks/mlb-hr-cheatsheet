#!/usr/bin/env python3
"""Hard verify June 13 sheet: duplicates, counts, summary, straights, bums."""
...
if sheet_date != "2026-06-13":
    errors.append(f"sheet-date wrong: {sheet_date}")
if "Saturday, June 13, 2026" not in text:
    errors.append("header weekday wrong: expected Saturday, June 13, 2026")
...
stale_june12 = [
    "Ketel Marte", "Kazuma Okamoto", "Ryan Waldschmidt", "Tommy Troy", "Daylen Lile",
    "Jackson Merrill", "Dillon Dingler", "Jared Young", "Victor Caratini", "Jacob Gonzalez",
    "Shohei Ohtani", "Mookie Betts", "Bryan Reynolds", "Spencer Steer", "Sean Sullivan",
]
for stale in stale_june12:
    if stale in text:
        errors.append(f"stale June 12 name still in preview: {stale}")

if errors:
    print("FAIL hard-verify-0613:")
    for e in errors:
        print(f"  {e}")
    raise SystemExit(1)

print("OK hard-verify-0613")
