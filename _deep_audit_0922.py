#!/usr/bin/env python3
"""Deep content audit for the 2026-09-22 sheet: prop coverage, markers, bums, staleness."""
...
# (name, game override, marker), generated from build-0922-from-csv.py RAW_PROPS so
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ("Cody Bellinger", "TB @ NYY (G1)", "⭐"),
    ("Austin Wells", "TB @ NYY (G1)", "💎"),
    ("Ben Rice", "TB @ NYY (G1)", "⭐"),
    ("Heliot Ramos", "TB @ NYY (G1)", "💎"),
    ("Victor Mesa Jr.", "TB @ NYY (G1)", ""),
    ("Junior Caminero", "TB @ NYY (G1)", ""),
    ("Jonathan Aranda", "TB @ NYY (G1)", ""),
    ("Pete Alonso", ANY, ""),
    ("Colton Cowser", ANY, ""),
    ...
    ("Patrick Bailey", ANY, ""),
    ("Austin Hedges", ANY, ""),
    ("Cody Bellinger", "TB @ NYY (G2)", "⭐"),
    ("Austin Wells", "TB @ NYY (G2)", "💎"),
    ("Ben Rice", "TB @ NYY (G2)", ""),
    ("Spencer Jones", "TB @ NYY (G2)", "💎"),
    ("Junior Caminero", "TB @ NYY (G2)", ""),
    ("Yandy Diaz", "TB @ NYY (G2)", "💎"),
    ("Austin Riley", ANY, ""),
    ("Drake Baldwin", ANY, ""),
    ("Brewer Hicklen", ANY, ""),
    ("Elly De La Cruz", ANY, "⭐"),
...
EXPECTED_BUMS = {'Sean Manaea', 'JR Ritchie', 'Logan Gilbert', 'Kyle Freeland', 'Brandon Williamson'}
...
def main() -> int:
    ...
    # 2026-09-22 rebalance the model ended in a clamp at 58 and a third of every
