#!/usr/bin/env python3
"""Build 2026-09-08 sheet from imported CSVs and user prop list."""
...
DATE = "2026-09-08"
OUT = ROOT / "build-sheet-2026-09-08.py"
BUM_RISK_MIN = 0.95

# Arms whose HR-risk row was carried from an earlier slate by
# build-synthetic-0908-matchups.py. Nothing is carried today: every arm the sheet
...
# Two Max Muncys are exported again. The owner's list places him between Mookie
# Betts and Elly De La Cruz -- squarely in the Dodgers run -- so that is the one he
# means, and the list ordering has been reliable all season. Worth flagging though:
# Los Angeles has Rojas at third tonight and no Muncy in the posted nine, and that
# prop carries no price, while Oakland's Max Muncy IS starting at DH at +630.
...
def main() -> int:
    ...
    # ships the prop list's typos: 2026-09-08 arrived with "Alejandro kirk". When the
    ...
    def canonical_case(name: str) -> str:
        ...
        "Alejandro kirk", 2026-09-08 sent "Alejanro Kirk", which matched nothing at
