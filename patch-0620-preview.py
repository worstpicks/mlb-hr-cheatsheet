#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-20. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-19.html"
SHEET_DATE = "2026-06-20"

spec = importlib.util.spec_from_file_location("build0620", ROOT / "build-sheet-2026-06-20.py")
...
ZONE_ROW_MIN = min(TOTAL_ROWS, max(45, TOTAL_ROWS - 12))
...
# 6/20 judgment: O0.5 + O1.5 from best attack lanes after initial pool pick.
...
# 6/20 Favorite 3-leg: user ⭐ favorites on this slate.
_fav3_pick_order = [
    "Kyle Schwarber",
    "Bryan Reynolds",
    "Max Muncy",
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 20, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Saturday, June 20, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
