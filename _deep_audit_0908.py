#!/usr/bin/env python3
"""Deep content audit for the 2026-09-08 sheet: prop coverage, markers, bums, staleness."""
...
GAMECOUNT = 15
WEEKDAY = "Tuesday"
DATE_TEXT = "September 8, 2026"

# (name, game override, marker), generated from build-0908-from-csv.py RAW_PROPS so
...
EXPECTED_BUMS = {'Casey Mize', 'Nick Lodolo', 'Sean Manaea'}
...
def main() -> int:
    ...
    # 2026-09-08 rebalance the model ended in a clamp at 58 and a third of every
