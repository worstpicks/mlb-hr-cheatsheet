#!/usr/bin/env python3
"""Deep content audit for the 2026-09-10 sheet: prop coverage, markers, bums, staleness."""
...
GAMECOUNT = 5
WEEKDAY = "Thursday"
DATE_TEXT = "September 10, 2026"

# (name, game override, marker), generated from build-0910-from-csv.py RAW_PROPS so
...
def main() -> int:
    ...
    # 2026-09-10 rebalance the model ended in a clamp at 58 and a third of every
