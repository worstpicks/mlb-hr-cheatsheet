...
if sheet_date != "2026-06-08":
    errors.append(f"sheet-date wrong: {sheet_date}")
if "Monday, June 8, 2026" not in text:
    errors.append("header weekday wrong: expected Monday, June 8, 2026")
if "Friday, June 8, 2026" in text:
    errors.append("header still says Friday, June 8, 2026")
