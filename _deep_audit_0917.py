#!/usr/bin/env python3
"""Deep content audit for the 2026-09-17 sheet: prop coverage, markers, bums, staleness."""
...
# (name, game override, marker), generated from build-0917-from-csv.py RAW_PROPS so
...
EXPECTED_BUMS = {'Kyle Harrison', 'Justin Wrobleski', 'Brady Singer'}
...
SUPERSEDED_PROBABLES: list[str] = ["Tyler Alexander"]  # opener; Cody Bradford is the bulk arm (PRIM)
...
def main() -> int:
    ...
    # 2026-09-17 rebalance the model ended in a clamp at 58 and a third of every
