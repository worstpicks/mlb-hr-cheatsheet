#!/usr/bin/env python3
"""Deep content audit for the 2026-09-01 sheet: prop coverage, markers, bums, staleness."""
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ('Ryan Vilade', ANY, GEM),
    ('Junior Caminero', ANY, STAR),
    ('Kenny Piper', ANY, GEM),
    ('Jorge Mateo', ANY, ""),
    ('Mark Vientos', ANY, GEM),
    ('Luis Torrens', ANY, ""),
    ...
    ('Turner Hill', ANY, ""),
    ('Drew Cavanaugh', ANY, ""),
    ('Nathaniel Lowe', ANY, STAR),
    ('Jose Ramirez', ANY, ""),
    ('Chase DeLauter', ANY, ""),
    ('Angel Genao', ANY, ""),
    ('Alejandro Kirk', ANY, STAR),
    ('Jesus Sanchez', ANY, GEM),
    ('Kazuma Okamoto', ANY, ""),
    ('Hector Rodriguez', ANY, ""),
    ('Sal Stewart', ANY, STAR),
    ('Elly De La Cruz', ANY, GEM),
    ...
    ('Jose Tena', ANY, GEM),
    ('Brady House', ANY, GEM),
    ('Mike Yastrzemski', ANY, GEM),
    ('Matt Olson', ANY, ""),
    ('Drake Baldwin', ANY, ""),
    ('Austin Riley', ANY, ""),
    ('Adley Rutschman', ANY, STAR),
    ...
    ('Vinnie Pasquantino', ANY, GEM),
    ('Kyle Stowers', ANY, STAR),
    ('Griffin Conine', ANY, ""),
    ('Tyrone Taylor', ANY, ""),
    ('Seiya Suzuki', ANY, STAR),
    ('Michael Busch', ANY, GEM),
    ('Pete Crow Armstrong', ANY, GEM),
    ('Jake Bauers', ANY, ""),
    ('Jackson Chourio', ANY, ""),
    ('Christian Yelich', ANY, ""),
    ('Andrew Vaughn', ANY, ""),
    ('Jake Burger', ANY, STAR),
    ('Justin Foscue', ANY, GEM),
    ('Wyatt Langford', ANY, GEM),
    ('Brandon Nimmo', ANY, ""),
    ('Tommy White', ANY, ""),
    ('Max Muncy', 'ATH @ TEX', ""),
    ...
    ('Hunter Goodman', ANY, ""),
    ('Willi Castro', ANY, ""),
    ('Blaze Alexander', ANY, STAR),
    ('Colton Cowser', ANY, ""),
    ('Pete Alonso', ANY, ""),
    ('Leody Taveras', ANY, ""),
    ('Dylan Beavers', ANY, STAR),
    ('Coby Mayo', ANY, ""),
    ('Vaughn Grissom', ANY, ""),
    ('Zach Neto', ANY, ""),
    ('Christian Moore', ANY, GEM),
    ("Travis d'Arnaud", ANY, ""),
    ('Spencer Jones', ANY, GEM),
    ('Heliot Ramos', ANY, ""),
    ('George Lombard Jr.', ANY, GEM),
    ('Cody Bellinger', ANY, ""),
    ('Amed Rosario', ANY, ""),
    ('Ketel Marte', ANY, GEM),
    ('Gabriel Moreno', ANY, GEM),
    ('Corbin Carroll', ANY, STAR),
    ('Tim Tawa', ANY, ""),
    ('Edmundo Sosa', ANY, GEM),
    ('Kyle Schwarber', ANY, GEM),
    ('Alec Bohm', ANY, ""),
    ('Max Muncy', 'STL @ LAD', ""),
...
EXPECTED_BUMS = {"Gavin Williams", "Sean Manaea", "Nick Lodolo"}

# Every game carries two pitcher segments. Ronel Blanco is missing from the HR-risk
# export and renders measured rates; Jedixson Paez has only three MLB innings, so his
# segment shows a season BAA labelled as such rather than a fabricated split.
...
SUPERSEDED_PROBABLES: list[str] = ["Spencer Arrighetti", "Brayan Bello", "Connor Prielipp", "Ryan Magdic"]
