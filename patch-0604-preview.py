#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-04. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-03.html"
SHEET_DATE = "2026-06-04"

spec = importlib.util.spec_from_file_location("build0604", ROOT / "build-sheet-2026-06-04.py")
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 4, 2026 — current slate", "href": "index.html"},
        {"date": "2026-06-03", "label": "June 3, 2026", "href": "archive/2026-06-03.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Thursday, June 4, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
