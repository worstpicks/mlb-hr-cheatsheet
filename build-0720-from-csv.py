#!/usr/bin/env python3
"""Build 2026-07-20 sheet from imported CSVs and user prop list."""
...
DATE = "2026-07-20"
OUT = ROOT / "build-sheet-2026-07-20.py"
BUM_RISK_MIN = 0.95
...
# No DH on 2026-07-20 — use PropFinder-derived games as-is.
...
def split_chc_doubleheader(games: dict[str, dict]) -> None:
    """No-op: 2026-07-20 has no doubleheader."""
    return
