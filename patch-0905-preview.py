#!/usr/bin/env python3
"""Patch preview sheet to 2026-09-05. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0905", ROOT / "build-sheet-2026-09-05.py")
...
weather_candidates = sorted(
    [r for r in weather_merged.values() if r.get("is_starting", True) and weather_play_ok(r)],
    key=lambda r: (
