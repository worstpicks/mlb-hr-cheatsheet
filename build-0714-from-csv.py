#!/usr/bin/env python3
"""Build 2026-07-14 All-Star Game sheet from imported CSVs and user prop list."""
...
DATE = "2026-07-14"
OUT = ROOT / "build-sheet-2026-07-14.py"
BUM_RISK_MIN = 0.95
...
def load_park_context(date: str) -> dict[str, dict]:
    ...
    with path.open(encoding="utf-8-sig", newline="") as f:
        ...
        for row in reader:
            ...
            # All-Star Game PropFinder export often leaves Game blank at CBP.
            if not key and "Citizens Bank" in venue:
                key = "AL @ NL"
            if not key:
                continue
            entry = {
