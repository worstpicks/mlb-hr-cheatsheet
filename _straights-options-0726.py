#!/usr/bin/env python3
"""List all Straight of the Day options for 2026-07-26."""
...
g: dict = {"__file__": str(ROOT / "patch-0726-preview.py"), "__name__": "__main__"}
exec(compile(cut + "\n", "patch-0726-preview.py", "exec"), g)
...
print("=" * 110)
print("CURRENT STRAIGHTS ON SHEET (7/26)")
print("=" * 110)
