#!/usr/bin/env python3
"""Build 2026-06-10 sheet from imported CSVs and user prop list."""
...
DATE = "2026-06-10"
OUT = ROOT / "build-sheet-2026-06-10.py"
...
ALIASES = {
    "Hunter Fedduccia": "Hunter Feduccia",
    "Cj Abrams": "CJ Abrams",
    ...
    "Freddie Fermin": "Freddy Fermin",
}

PROBABLE_OVERRIDES: dict[str, dict] = {
    "STL @ NYM": {"side": "home", "from": "Warren", "to": "Peterson", "full": "David Peterson"},
}
