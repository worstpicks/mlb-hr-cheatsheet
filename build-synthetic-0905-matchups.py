#!/usr/bin/env python3
"""Synthesize the hr-matchups game PropFinder did not export for 2026-09-05.
...
GAPS: dict[str, dict] = {
    # 2026-09-05: nothing to fill. All 26 arms on the 13-game slate shipped a real
    # PropFinder export with a full batter block, so no lineup is reconstructed and
    # no form is carried from another day. Leaving a prior slate's spec in here would
    # fabricate rows for arms that are not even pitching today.
}
