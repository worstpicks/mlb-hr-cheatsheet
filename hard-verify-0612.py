#!/usr/bin/env python3
"""Hard verify June 12 sheet: duplicates, counts, summary, straights, bums."""
...
if sheet_date != "2026-06-12":
    errors.append(f"sheet-date wrong: {sheet_date}")
if "Friday, June 12, 2026" not in text:
    errors.append("header weekday wrong: expected Friday, June 12, 2026")
...
stale_june11 = [
    "Marcus Semien", "Juan Soto", "Kody Clemens", "Ezequiel Tovar", "Otto Lopez",
    "Jorge Barrosa", "Bobby Witt Jr.", "Starling Marte", "Jackson Holliday", "Jorge Mateo",
    "Francisco Alvarez", "Adley Rutschman", "Spencer Torkelson",
]
for stale in stale_june11:
    if stale in text:
        errors.append(f"stale June 11 name still in preview: {stale}")

if errors:
    print("FAIL hard-verify-0612:")
    for e in errors:
        print(f"  {e}")
    raise SystemExit(1)

print("OK hard-verify-0612")
