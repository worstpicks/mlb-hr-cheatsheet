#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-23. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-22.html"
SHEET_DATE = "2026-07-23"

spec = importlib.util.spec_from_file_location("build0723", ROOT / "build-sheet-2026-07-23.py")
...
def update_manifest():
    ...
    if "2026-07-22" in old or (ARCHIVE_PREVIOUS.is_file()):
        old["2026-07-22"] = {
            "date": "2026-07-22",
            "label": "July 22, 2026",
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 23, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-07-22",
        "2026-07-21",
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Thursday, July 23, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
