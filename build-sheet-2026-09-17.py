...
games = [
    ...
    },
    {
        ...
        "description": "Tail key data: Park boost -12% (stadium -5%, weather -7%). Valdez (HR risk -0.79, vs LHB -0.63, vs RHB -0.55). Fedde (HR risk -0.09, vs LHB -0.15, vs RHB +0.18).",
        "rows": [
            row("Munetaka Murakami", "L", "N/A", 68, "", ["vs Valdez"], """1 HR, 2 near-HR, 92.9 mph EV, 12.5% barrels. Valdez LHB split -0.63, HR risk -0.79. tough split lane (-0.63); pitcher suppresses HR (-0.79).""", blast="good", contact={'stars': 2, 'k': 26.5, 'batterK': 45.2, 'batterWhiff': 46.2, 'pitcherK': 13.9}),
            ...
            row("Tommy Pham", "R", "+690", 63, "", ["vs Valdez"], """1 HR, 1 near-HR, 94.8 mph EV, 33.3% barrels. Valdez RHB split -0.55, HR risk -0.79. tough split lane (-0.55); pitcher suppresses HR (-0.79).""", blast="good", contact={'stars': 4, 'k': 19.3, 'batterK': 42.1, 'batterWhiff': 35.3, 'pitcherK': 13.9}),
            row("Andrew Benintendi", "L", "N/A", 53, "", ["vs Valdez"], """0 HR, 93.9 mph EV, 12.5% barrels. Valdez LHB split -0.63, HR risk -0.79. tough split lane (-0.63); pitcher suppresses HR (-0.79).""", blast="good", contact={'stars': 5, 'k': 15.9, 'batterK': 16.9, 'batterWhiff': 19.4, 'pitcherK': 13.9}),
            row("Spencer Torkelson", "R", "+471", 78, "🌕 💣 💎", ["vs Fedde"], """Worst Pickz Hidden Gem. 2 HR, 3 near-HR, 87.8 mph EV, 25.0% barrels. Fedde RHB split +0.18, HR risk -0.09. pitcher risk below avg (-0.09); park/weather net drag (-12%).""", blast="high", contact={'stars': 3, 'k': 23.4, 'batterK': 33.3, 'batterWhiff': 36.2, 'pitcherK': 15.4}),
            ...
            row("Gleyber Torres", "R", "+900", 50, "", ["vs Fedde"], """0 HR, 93.7 mph EV. Fedde RHB split +0.18, HR risk -0.09. pitcher risk below avg (-0.09); park/weather net drag (-12%).""", blast="good", contact={'stars': 4, 'k': 18.2, 'batterK': 21.5, 'batterWhiff': 20.0, 'pitcherK': 15.4}),
    ...
    },
    {
        ...
        "description": "Tail key data: Park boost -6% (stadium -10%, weather +4%). Bradley (HR risk 0.33, vs LHB +0.62, vs RHB -0.15). Urena (HR risk -0.49, vs LHB -0.83, vs RHB +0.20).",
        "rows": [
            row("Moises Ballesteros", "L", "+630", 84, "🌕 💣 💎", ["vs Bradley"], """Worst Pickz Hidden Gem. 2 HR, 2 near-HR, 97.0 mph EV, 25.0% barrels. Bradley LHB split +0.62, HR risk 0.33. park/weather net drag (-6%).""", blast="high", contact={'stars': 2, 'k': 27.0, 'batterK': 27.3, 'batterWhiff': 28.0, 'pitcherK': 27.4}),
            row("Vaughn Grissom", "R", "+870", 76, "", ["vs Bradley"], """1 HR, 2 near-HR, 94.7 mph EV, 25.0% barrels. Bradley RHB split -0.15, HR risk 0.33. slight split headwind (-0.15); park/weather net drag (-6%).""", blast="good", contact={'stars': 3, 'k': 24.0, 'batterK': 20.9, 'batterWhiff': 21.6, 'pitcherK': 27.4}),
            row("Josh Lowe", "L", "+640", 66, "", ["vs Bradley"], """1 HR, 1 near-HR, 85.1 mph EV, 12.5% barrels. Bradley LHB split +0.62, HR risk 0.33. park/weather net drag (-6%); lighter EV form (85.1 mph).""", blast="good", contact={'stars': 1, 'k': 29.2, 'batterK': 31.5, 'batterWhiff': 37.3, 'pitcherK': 27.4}),
            ...
            row("Royce Lewis", "R", "+500", 66, "💎", ["vs Urena"], """Worst Pickz Hidden Gem. 0 HR, 1 near-HR, 92.5 mph EV, 25.0% barrels. Urena RHB split +0.20, HR risk -0.49. pitcher suppresses HR (-0.49); park/weather net drag (-6%).""", blast="good", contact={'stars': 3, 'k': 23.5, 'batterK': 21.3, 'batterWhiff': 29.4, 'pitcherK': 23.5}),
        ],
    },
    {
        ...
        "description": "Tail key data: Park boost +12% (stadium -2%, weather +15%). Nola (HR risk 0.35, vs LHB +0.38, vs RHB +0.28). McLean (HR risk -0.64, vs LHB -0.19, vs RHB -0.97).",
        "rows": [
            row("Carson Benge", "L", "+670", 87, "🌕 💣", ["vs Nola"], """1 HR, 1 near-HR, 97.5 mph EV, 37.5% barrels. Nola LHB split +0.38, HR risk 0.35.""", blast="high", contact={'stars': 2, 'k': 24.8, 'batterK': 27.3, 'batterWhiff': 25.6, 'pitcherK': 23.9}),
            row("Jared Young", "L", "+545", 73, "🚀 💎", ["vs Nola"], """Worst Pickz Hidden Gem. 0 HR, 102.1 mph EV, 12.5% barrels. Nola LHB split +0.38, HR risk 0.35. limited recent HR events.""", blast="good", contact={'stars': 3, 'k': 21.0, 'batterK': 17.1, 'batterWhiff': 20.4, 'pitcherK': 23.9}),
            row("Juan Soto", "L", "+299", 81, "💎", ["vs Nola"], """Worst Pickz Hidden Gem. 0 HR, 99.3 mph EV. Nola LHB split +0.38, HR risk 0.35. limited recent HR events.""", blast="good", contact={'stars': 3, 'k': 21.5, 'batterK': 17.2, 'batterWhiff': 24.3, 'pitcherK': 23.9}),
            row("Francisco Alvarez", "R", "+525", 72, "", ["vs Nola"], """0 HR, 1 near-HR, 92.7 mph EV. Nola RHB split +0.28, HR risk 0.35. limited recent HR events.""", blast="good", contact={'stars': 1, 'k': 30.7, 'batterK': 41.1, 'batterWhiff': 41.5, 'pitcherK': 23.9}),
            row("Brett Baty", "L", "+600", 77, "", ["vs Nola"], """1 HR, 1 near-HR, 93.9 mph EV, 12.5% barrels. Nola LHB split +0.38, HR risk 0.35.""", blast="good", contact={'stars': 2, 'k': 24.1, 'batterK': 18.5, 'batterWhiff': 31.8, 'pitcherK': 23.9}),
            row("Francisco Lindor", "S", "+364", 89, "🌕 💣", ["vs Nola"], """2 HR, 2 near-HR, 90.8 mph EV, 12.5% barrels. Nola SHB→LHB split +0.38, HR risk 0.35.""", blast="high", contact={'stars': 2, 'k': 25.3, 'batterK': 27.7, 'batterWhiff': 27.3, 'pitcherK': 23.9}),
            row("Bo Bichette", "R", "+700", 66, "", ["vs Nola"], """0 HR, 96.1 mph EV. Nola RHB split +0.28, HR risk 0.35. limited recent HR events.""", blast="good", contact={'stars': 3, 'k': 20.9, 'batterK': 18.2, 'batterWhiff': 19.6, 'pitcherK': 23.9}),
            row("Kyle Schwarber", "L", "+295", 80, "⭐", ["vs McLean"], """Worst Pickz Favorite. 1 HR, 1 near-HR, 99.5 mph EV, 12.5% barrels. McLean LHB split -0.19, HR risk -0.64. slight split headwind (-0.19); pitcher suppresses HR (-0.64).""", blast="good", contact={'stars': 2, 'k': 25.7, 'batterK': 27.5, 'batterWhiff': 30.0, 'pitcherK': 23.9}),
            row("Bryce Harper", "L", "+465", 76, "💎", ["vs McLean"], """Worst Pickz Hidden Gem. 1 HR, 1 near-HR, 92.5 mph EV, 12.5% barrels. McLean LHB split -0.19, HR risk -0.64. slight split headwind (-0.19); pitcher suppresses HR (-0.64).""", blast="good", contact={'stars': 2, 'k': 25.7, 'batterK': 25.9, 'batterWhiff': 33.3, 'pitcherK': 23.9}),
            row("Brandon Marsh", "L", "+860", 53, "💎", ["vs McLean"], """Worst Pickz Hidden Gem. 0 HR, 1 near-HR, 89.5 mph EV, 12.5% barrels. McLean LHB split -0.19, HR risk -0.64. slight split headwind (-0.19); pitcher suppresses HR (-0.64).""", contact={'stars': 3, 'k': 22.8, 'batterK': 23.5, 'batterWhiff': 22.9, 'pitcherK': 23.9}),
        ],
    },
    {
