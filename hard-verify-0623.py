#!/usr/bin/env python3
"""Hard verify June 23 sheet: duplicates, counts, summary, straights, bums."""
...
if sheet_date != "2026-06-23":
    errors.append(f"sheet-date wrong: {sheet_date}")
if "Tuesday, June 23, 2026" not in text:
    errors.append("header weekday wrong: expected Tuesday, June 23, 2026")
...
stale_june20_only = [
    "Kody Clemens", "Endy Rodriguez", "Gabriel Arias",
    "Tomoyuki Sugano", "Connelly Early", "Taj Bradley", "Kyle Karros",
    "Mark Vientos", "Julio Rodriguez", "Trevor Larnach",
]
...
if summary_start != -1 and summary_end != -1 and summary_end > summary_start:
    ...
    stale_summary = [
        "Kody Clemens", "Tomoyuki Sugano", "Zac Gallen", "Joey Cantillo",
    ]
...
if errors:
    print("FAIL hard-verify-0623:")
    for e in errors:
        print(f"  {e}")
    raise SystemExit(1)

print("OK hard-verify-0623")
