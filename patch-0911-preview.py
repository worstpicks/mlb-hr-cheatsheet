#!/usr/bin/env python3
"""Patch preview sheet to 2026-09-11. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0911", ROOT / "build-sheet-2026-09-11.py")
...
# Score gates below are percentile-matched to the pre-2026-09-11 scale. The rating
