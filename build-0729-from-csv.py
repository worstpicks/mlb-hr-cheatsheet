#!/usr/bin/env python3
"""Build 2026-07-29 sheet from imported CSVs and user prop list."""
...
DATE = "2026-07-29"
OUT = ROOT / "build-sheet-2026-07-29.py"
BUM_RISK_MIN = 0.95
...
ALIASES = {
    "Brian Narvarreto": "Brian Navarreto",
...
ATL_NYM_DH_SPECS: dict[str, dict] = {
    "ATL @ NYM (G1)": {
        "away_sp": "Smith-Shawver",
        "home_sp": "Manaea",
        "away_sp_full": "AJ Smith-Shawver",
        "home_sp_full": "Sean Manaea",
        "files": [
            "hr-matchups-ATL-at-NYM-AJ-Smith-Shawver-2026-07-29.csv",
            "hr-matchups-ATL-at-NYM-Sean-Manaea-2026-07-29.csv",
        ],
    },
    "ATL @ NYM (G2)": {
        "away_sp": "Sale",
        "home_sp": "Scott",
        "away_sp_full": "Chris Sale",
        "home_sp_full": "Christian Scott",
        "files": [
            "hr-matchups-ATL-at-NYM-Chris-Sale-2026-07-29.csv",
            "hr-matchups-ATL-at-NYM-Christian-Scott-2026-07-29.csv",
        ],
    },
}
