...
checks = [
    ...
    ("Straight CSV Bradley split", "+0.66 vs LHB" in t),
    ("Straight Horwitz multi-HR", "3 HR, 3 near-HR" in t),
    ...
    ("Top5 Soto 95", "Juan Soto <small>6 HR, Meyer RHB split, 33.3% barrels</small></span><strong>95</strong>" in t),
    ...
    ("Attack Fedde", "Erick Fedde</strong><small>Slate-high HR risk (1.67)" in t),
