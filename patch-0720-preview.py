#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-20. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-19.html"
SHEET_DATE = "2026-07-20"

spec = importlib.util.spec_from_file_location("build0720", ROOT / "build-sheet-2026-07-20.py")
...
# 7/20 Fav3: data-driven from user ⭐ (straights excluded upstream).
...
def update_manifest():
    ...
    if "2026-07-19" in old or (ARCHIVE_PREVIOUS.is_file()):
        old["2026-07-19"] = {
            "date": "2026-07-19",
            "label": "July 19, 2026",
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 20, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-07-19",
        "2026-07-18",
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Monday, July 20, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
