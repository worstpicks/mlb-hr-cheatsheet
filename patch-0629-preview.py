#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-29. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-28.html"
SHEET_DATE = "2026-06-29"

spec = importlib.util.spec_from_file_location("build0629", ROOT / "build-sheet-2026-06-29.py")
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 29, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Monday, June 29, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
