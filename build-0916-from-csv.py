#!/usr/bin/env python3
"""Build 2026-09-16 sheet from imported CSVs and user prop list."""
...
DATE = "2026-09-16"
OUT = ROOT / "build-sheet-2026-09-16.py"
BUM_RISK_MIN = 0.95

# Arms whose HR-risk row was carried from an earlier slate by
# build-synthetic-0916-matchups.py. Nothing is carried today: every arm the sheet
...
BATTER_GAME_OVERRIDES: dict[str, str] = {
    # Two Max Muncys and no team tag on the list; the owner confirmed the Dodger. He is
    # not in Los Angeles' projected lineup today, so he stays on the board but is
    # barred from picks.
    "Max Muncy": "LAD @ CIN",
}
...
def main() -> int:
    ...
    # ships the prop list's typos: 2026-09-16 arrived with "Alejandro kirk". When the
    ...
    def canonical_case(name: str) -> str:
        ...
        "Alejandro kirk", 2026-09-16 sent "Alejanro Kirk", which matched nothing at
