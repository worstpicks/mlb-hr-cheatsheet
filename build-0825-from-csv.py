#!/usr/bin/env python3
"""Build 2026-08-25 sheet from imported CSVs and user prop list."""
...
DATE = "2026-08-25"
OUT = ROOT / "build-sheet-2026-08-25.py"
BUM_RISK_MIN = 0.95

# Arms whose HR-risk row was carried from an earlier slate by
# build-synthetic-0825-matchups.py. Nothing is carried today: every arm the sheet
...
ALIASES = {
    # prop-list typos
    "A.j Ewing": "A.J. Ewing",
    "Hector Rodridguez": "Hector Rodriguez",
...
PITCHER_HAND = {
    # PropFinder spells him "Zach"; MLB has both a "Zac Thornton" (L) and a
    # "Zack Thornton" (R), so the name lookup correctly refuses to guess between
    # them. New York's arm is Zac, the lefty.
    "Zach Thornton": "L",
