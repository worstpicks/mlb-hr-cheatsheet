#!/usr/bin/env python3
"""Deep content audit for the 2026-09-11 sheet: prop coverage, markers, bums, staleness."""
...
# (name, game override, marker), generated from build-0911-from-csv.py RAW_PROPS so
...
EXPECTED_BUMS = {'Mason Adams', 'Miguel Ullola'}
...
def main() -> int:
    ...
    # 2026-09-11 rebalance the model ended in a clamp at 58 and a third of every
