#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-10. Does not commit or push."""
...
SHEET_DATE = "2026-07-10"

spec = importlib.util.spec_from_file_location("build0710", ROOT / "build-sheet-2026-07-10.py")
...
# 7/10 best pair: Michael Conforto O0.5 vs Greene 🧤 (CHC @ CIN);
# Manny Machado O1.5 vs Bieber 🧤 (TOR @ SD). Different games; top combined comp.
_o05_lock = rows_by_plain_early.get("Michael Conforto")
_o15_lock = rows_by_plain_early.get("Manny Machado")
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Thursday, July 10, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
