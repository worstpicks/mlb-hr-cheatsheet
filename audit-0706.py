#!/usr/bin/env python3
"""Quick audit for 2026-07-06 sheet before push."""
...
EXPECTED_GAMES = 8
EXPECTED_PROPS = 50
ZONE_MIN = EXPECTED_PROPS

if 'sheet-date" content="2026-07-06"' not in html:
...
if not (ROOT / "preview" / "data" / "research-2026-07-06.json").exists():
    errors.append("missing preview/data/research-2026-07-06.json")
if not (ROOT / "preview" / "data" / "park-factors-2026-07-06.json").exists():
    errors.append("missing preview/data/park-factors-2026-07-06.json")
...
spec = importlib.util.spec_from_file_location("b", ROOT / "build-sheet-2026-07-06.py")
...
if manifest["sheets"][0]["date"] != "2026-07-06":
    errors.append("manifest current slate not 2026-07-06")
if not (ROOT / "preview" / "archive" / "2026-07-03.html").exists():
    errors.append("missing archive 2026-07-03.html")

if errors:
    print("FAIL audit-0706:")
    for e in errors:
        print(" ", e)
    raise SystemExit(1)

print(
    f"OK audit-0706 — sheet-date, {EXPECTED_GAMES}/{EXPECTED_GAMES} park headers, "
