#!/usr/bin/env python3
"""Patch preview sheet to 2026-09-04. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0904", ROOT / "build-sheet-2026-09-04.py")
...
def _mark_starting(all_rows: list[dict]) -> int:
    ...
    benched = 0
    for r in all_rows:
        rec = lookup_research_entry(stats, r["name_plain"]) or {}
