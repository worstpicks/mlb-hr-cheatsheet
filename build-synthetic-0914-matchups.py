#!/usr/bin/env python3
"""Fill hr-matchups PropFinder did not export for 2026-09-14.

  Nothing to fill. All 10 games shipped both arms with real batter tables. A gap
  goes in GAPS and is filled from that hitter's most recent real export rather than
  from a league default; this run exists to prove there is nothing to fill.
"""
...
GAPS: dict[str, dict] = {
    # Nothing to fill today: all 20 exports carry a real batter table.
}
