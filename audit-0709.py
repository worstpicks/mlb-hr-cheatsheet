#!/usr/bin/env python3
"""Quick audit for 2026-07-09 sheet before push."""
...
if 'sheet-date" content="2026-07-09"' not in html:
...
if not (ROOT / "preview" / "data" / "research-2026-07-09.json").exists():
    errors.append("missing preview/data/research-2026-07-09.json")
if not (ROOT / "preview" / "data" / "park-factors-2026-07-09.json").exists():
    errors.append("missing preview/data/park-factors-2026-07-09.json")
...
if manifest["sheets"][0]["date"] != "2026-07-09":
    errors.append("manifest current slate not 2026-07-09")

if errors:
    print("FAIL audit-0709:")
    for e in errors:
        print(" ", e)
    raise SystemExit(1)

print(
    f"OK audit-0709 — sheet-date, {EXPECTED_GAMES}/{EXPECTED_GAMES} park headers, "
