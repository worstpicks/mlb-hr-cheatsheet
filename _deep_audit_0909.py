#!/usr/bin/env python3
"""Deep content audit for the 2026-09-09 sheet: prop coverage, markers, bums, staleness."""
...
GAMECOUNT = 15
WEEKDAY = "Wednesday"
DATE_TEXT = "September 9, 2026"

# (name, game override, marker), generated from build-0909-from-csv.py RAW_PROPS so
...
EXPECTED_BUMS = {'Tomoyuki Sugano', 'Will Warren', 'Zac Gallen'}
...
SUPERSEDED_PROBABLES: list[str] = ["Didier Fuentes"]  # export arm; Atlanta start Reynaldo Lopez
...
def main() -> int:
    ...
    # 2026-09-09 rebalance the model ended in a clamp at 58 and a third of every
