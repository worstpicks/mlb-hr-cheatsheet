...
games = [
    ...
    {
        "title": "LAD @ SD - LAD Starter TBD (R, LAD) vs Randy Vasquez (R, SD)",
        "description": "Petco Park — slightly negative HR model but the live feed shows wind out. Vasquez allows enough RHB risk for Will Smith/Pages-type contact; LAD starter needs final confirmation before playing Padres bats.",
        "rows": [
            row("Miguel Andujar", "R", "+940", 70, "💎", ["vs TBD"], n("Miguel Andujar", "TBD", "LAD starter changed from the first feed", "1 HR with .312 ISO, but matchup needs a pitcher re-check")),
            row("Gavin Sheets", "L", "+575", 75, "💎", ["vs TBD"], n("Gavin Sheets", "TBD", "LAD starter changed from the first feed", "1 HR with .300 ISO and strong OBP form, but matchup needs a pitcher re-check")),
            row("Ramon Laureano", "R", "+760", 64, "💎", ["vs TBD"], n("Ramon Laureano", "TBD", "LAD starter changed from the first feed", "Submitted-card inclusion with limited current power sample, but matchup needs a pitcher re-check")),
            row("Ty France", "R", "N/A", 67, "💎", ["vs TBD"], n("Ty France", "TBD", "LAD starter changed from the first feed", "28.6% barrels in a tiny sample keeps him barely alive, but matchup needs a pitcher re-check")),
