#!/usr/bin/env python3
"""Quick audit for 2026-07-07 sheet before push."""
...
if 'sheet-date" content="2026-07-07"' not in html:
...
if not (ROOT / "preview" / "data" / "research-2026-07-07.json").exists():
    errors.append("missing preview/data/research-2026-07-07.json")
if not (ROOT / "preview" / "data" / "park-factors-2026-07-07.json").exists():
    errors.append("missing preview/data/park-factors-2026-07-07.json")
...
if manifest["sheets"][0]["date"] != "2026-07-07":
    errors.append("manifest current slate not 2026-07-07")
if not (ROOT / "preview" / "archive" / "2026-07-06.html").exists():
    errors.append("missing archive 2026-07-06.html")

if errors:
    print("FAIL audit-0707:")
    for e in errors:
        print(" ", e)
    raise SystemExit(1)

print(
    f"OK audit-0707 — sheet-date, {EXPECTED_GAMES}/{EXPECTED_GAMES} park headers, "
