#!/usr/bin/env python3
"""Deep content audit for the 2026-08-28 sheet: prop coverage, markers, bums, staleness."""
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ...
    ('Hunter Feduccia', ANY, ""),
    ('Dylan Crews', ANY, ""),
    ('Andres Chaparro', ANY, STAR),
    ('Daylen Lile', ANY, ""),
    ('Andrew Pinckney', ANY, ""),
    ('Jose Tena', ANY, ""),
    ('Heriberto Hernandez', ANY, STAR),
    ('Esteury Ruiz', ANY, GEM),
    ...
    ('Bo Bichette', ANY, ""),
    ('Brett Baty', ANY, GEM),
    ('Yordan Alvarez', ANY, GEM),
    ('Daulton Varsho', ANY, GEM),
    ('Jeremy Pena', ANY, STAR),
    ('Nelson Velazquez', ANY, ""),
    ('Jose Ramirez', ANY, GEM),
    ('Jo Adell', ANY, ""),
    ('Angel Genao', ANY, ""),
    ('Chase DeLauter', ANY, ""),
    ...
    ('Jesus Sanchez', ANY, STAR),
    ('Nathan Lukes', ANY, ""),
    ('Alejandro Kirk', ANY, ""),
    ('Cal Raleigh', ANY, STAR),
    ('Randy Arozarena', ANY, GEM),
    ('Patrick Wisdom', ANY, GEM),
    ('Dominic Canzone', ANY, GEM),
    ('Jazz Chisholm Jr.', ANY, ""),
    ('Ben Rice', ANY, GEM),
    ('Spencer Jones', ANY, ""),
    ('Heliot Ramos', ANY, GEM),
    ('George Lombard Jr.', ANY, ""),
    ('Adley Rutschman', ANY, STAR),
    ('Jarren Duran', ANY, STAR),
    ('Mickey Gasper', ANY, ""),
    ('Wilyer Abreu', ANY, ""),
    ...
    ('Austin Riley', ANY, ""),
    ('Brewer Hicklen', ANY, ""),
    ('Hunter Goodman', ANY, STAR),
    ('Mickey Moniak', ANY, STAR),
    ('Willi Castro', ANY, ""),
    ('Connor Norby', ANY, ""),
    ('Troy Johnston', ANY, GEM),
    ('Ezequiel Tovar', ANY, ""),
    ('Jackson Chourio', ANY, STAR),
    ('Christian Yelich', ANY, STAR),
    ('Garrett Mitchell', ANY, STAR),
    ('Andrew Vaughn', ANY, ""),
    ('Jake Burger', ANY, ""),
    ('Corey Seager', ANY, STAR),
    ('Ryan Jeffers', ANY, GEM),
    ('Luke Keaschall', ANY, ""),
    ('Trevor Larnach', ANY, GEM),
    ('Brooks Lee', ANY, ""),
    ('Kaelen Culpepper', ANY, ""),
    ('Tristan Peters', ANY, GEM),
    ('Miguel Vargas', ANY, ""),
    ('Braden Montgomery', ANY, STAR),
    ...
    ('Zach Neto', ANY, STAR),
    ('Josh Lowe', ANY, ""),
    ('Christian Moore', ANY, STAR),
    ('Mike Trout', ANY, STAR),
    ('Bryce Harper', ANY, GEM),
    ('JT Realmuto', ANY, ""),
    ('Kyle Schwarber', ANY, ""),
    ('Alec Bohm', ANY, GEM),
    ('Trea Turner', ANY, ""),
...
EXPECTED_BUMS = {"Kohl Drake", "Luis Castillo", "Tomoyuki Sugano"}

# Every game carries two pitcher segments. Emerson Hancock and Jacob Lopez are
...
SUPERSEDED_PROBABLES: list[str] = []  # no probable changed and no gap-fill was needed
