...
patch_globals: dict = {"__file__": str(ROOT / "patch-0626-preview.py"), "__name__": "__main__"}
cut = (ROOT / "patch-0626-preview.py").read_text(encoding="utf-8").split("THREE_LEG_HR =")[0]
exec(compile(cut + "\n", "patch-0626-preview.py", "exec"), patch_globals)
