#!/usr/bin/env python3
"""Hard verify June 14 sheet: duplicates, counts, summary, straights, bums."""
...
if sheet_date != "2026-06-15":
    errors.append(f"sheet-date wrong: {sheet_date}")
if "Monday, June 15, 2026" not in text:
    errors.append("header weekday wrong: expected Monday, June 15, 2026")
...
stale_june14 = [
    "Luke Raley", "Kody Clemens", "Colson Montgomery", "Michael Harris II",
    "Nick Kurtz", "Lawrence Butler", "Cedric Mullins", "Dominic Canzone",
    "Will Benson", "Patrick Wisdom", "Kazuma Okamoto", "Jazz Chisholm Jr.",
    "Daylen Lile", "Luis Garcia Jr.", "CJ Abrams", "Dominic Smith",
    "Andrew Benintendi", "Joc Pederson", "Willy Adames", "Kyle Higashioka",
    "Matt Chapman", "Tristan Peters", "Braden Montgomery", "Miguel Vargas",
    "Wilyer Abreu", "Justin Foscue", "Jonathan Aranda", "Starling Marte",
    "Pete Alonso", "Samuel Basallo", "Manny Machado", "Marcus Semien",
    "Matt Olson", "James Outman", "JJ Bleday", "Ryan Waldschmidt", "Josh Bell",
    "Blaze Jordan", "Andrew Vaughn", "Brandon Marsh", "Edmundo Sosa",
    "Michael Massey", "Jeffrey Springs", "Miles Mikolas", "Tomoyuki Sugano",
    "Grayson Rodriguez", "Nathan Eovaldi", "Walker Buehler", "Paul Skenes",
    "Willi Castro", "Cole Carrigg", "TJ Rumfield", "Jimmy Crooks", "Ben Rice",
    "Rhys Hoskins", "Adley Rutschman", "Jordan Walker", "Nelson Velazquez",
    "Ryan McMahon", "Cody Bellinger", "Dylan Crews", "Ryan O'Hearn",
    "Kyle Stowers", "Blaze Alexander", "Jorge Mateo", "Angel Martinez",
    "Spencer Torkelson", "Wenceel Perez", "Tyler Stephenson", "Ryan Ward",
    "Dalton Rushing", "Jarren Duran", "Caleb Durbin", "Gary Sanchez",
    "Jackson Chourio", "Garrett Mitchell", "Jeremy Pena", "Jonah Cox",
    "Mike Burrows", "Sean Sullivan", "Kyle Freeland", "Joey Estes",
]
for stale in stale_june14:
    if stale in text:
        errors.append(f"stale prior-slate name still in preview: {stale}")

if errors:
    print("FAIL hard-verify-0615:")
    for e in errors:
        print(f"  {e}")
    raise SystemExit(1)

print("OK hard-verify-0615")
