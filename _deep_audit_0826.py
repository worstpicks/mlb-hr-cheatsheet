#!/usr/bin/env python3
"""Deep content audit for the 2026-08-26 sheet: prop coverage, markers, bums, staleness."""
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ...
    ('Oneil Cruz', ANY, STAR),
    ('Rafael Flores', ANY, ""),
    ('Brandon Lowe', ANY, STAR),
    ('Bryan Reynolds', ANY, STAR),
    ...
    ('Willi Castro', ANY, ""),
    ('Brett Sullivan', ANY, ""),
    ('Mickey Moniak', ANY, GEM),
    ('Hunter Goodman', ANY, ""),
    ('Troy Johnston', ANY, ""),
    ('Luis Garcia Jr.', ANY, STAR),
    ('Spencer Jones', ANY, STAR),
    ('Trent Grisham', ANY, GEM),
    ('Cody Bellinger', ANY, STAR),
    ('Jeremy Pena', ANY, ""),
    ('Nick Allen', ANY, ""),
    ('Taylor Trammell', ANY, ""),
    ('Yordan Alvarez', ANY, ""),
    ...
    ('Luis Robert', ANY, STAR),
    ('Luis Torrens', ANY, GEM),
    ('Brett Baty', ANY, STAR),
    ('Joey Ortiz', ANY, GEM),
    ('Jake Bauers', ANY, STAR),
    ...
    ('Michael Harris II', ANY, STAR),
    ('Brewer Hicklen', ANY, ""),
    ('Shohei Ohtani', ANY, STAR),
    ('Max Muncy', 'LAD @ ATL', GEM),
    ('Hunter Feduccia', ANY, STAR),
    ('Kyle Tucker', ANY, ""),
    ('Randal Grichuk', ANY, STAR),
    ('Miguel Vargas', ANY, STAR),
    ('Jake Rogers', ANY, GEM),
    ('Colson Montgomery', ANY, GEM),
    ('Munetaka Murakami', ANY, STAR),
    ('Joc Pederson', ANY, ""),
    ('Brandon Nimmo', ANY, ""),
    ('Corey Seager', ANY, GEM),
    ('Jake Burger', ANY, GEM),
    ('Justin Foscue', ANY, ""),
    ('Jordan Walker', ANY, ""),
...
EXPECTED_BUMS = {"Tanner Gordon", "Nick Lodolo", "Matthew Boyd", "Ryan Gusto"}

# Every game carries two pitcher segments. Elmer Rodriguez is missing from
# PropFinder's HR-risk export -- MLB still lists New York as TBD -- so his header
# renders his real 2026 measured rates.
...
SUPERSEDED_PROBABLES: list[str] = ["Gerrit Cole", "Brad Lord"]  # NYY export arm; stale WSH name in the paste
