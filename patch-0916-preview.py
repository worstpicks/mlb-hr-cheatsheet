#!/usr/bin/env python3
"""Patch preview sheet to 2026-09-16. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0916", ROOT / "build-sheet-2026-09-16.py")
...
# Score gates below are percentile-matched to the pre-2026-09-16 scale. The rating
