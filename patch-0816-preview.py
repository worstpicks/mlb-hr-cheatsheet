#!/usr/bin/env python3
"""Patch preview sheet to 2026-08-16. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-08-15.html"
SHEET_DATE = "2026-08-16"

spec = importlib.util.spec_from_file_location("build0816", ROOT / "build-sheet-2026-08-16.py")
...
# 8/16 judgment: Lindor has the most complete O0.5 lane — a +1.43 platoon split into
...
def update_manifest():
    ...
    if "2026-08-15" in old or ARCHIVE_PREVIOUS.is_file():
        old["2026-08-15"] = {
            "date": "2026-08-15",
            "label": "August 15, 2026",
            "href": "archive/2026-08-15.html",
        }
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "August 16, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-08-15",
        "2026-08-14",
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Sunday, August 16, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
