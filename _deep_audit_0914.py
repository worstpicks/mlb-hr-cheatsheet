#!/usr/bin/env python3
"""Deep content audit for the 2026-09-14 sheet: prop coverage, markers, bums, staleness."""
...
# (name, game override, marker), generated from build-0914-from-csv.py RAW_PROPS so
...
def main() -> int:
    ...
    # 2026-09-14 rebalance the model ended in a clamp at 58 and a third of every
