#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-28. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-27.html"
SHEET_DATE = "2026-06-28"

spec = importlib.util.spec_from_file_location("build0628", ROOT / "build-sheet-2026-06-28.py")
...
# 6/28 judgment: Sheets is the clearest O0.5 platoon lane (+0.32 vs Sheehan 0.45 risk).
_sheets_o05 = rows_by_plain_early.get("Gavin Sheets")
if (
    _sheets_o05
    and straight_o05
    and straight_o05["name_plain"] == "Mookie Betts"
    and straight_o15
    and straight_o15["game_key"] != _sheets_o05["game_key"]
    and _sheets_o05["split"] >= 0.15
):
    straight_o05 = _sheets_o05
    straight_names = {straight_o05["name"], straight_o15["name"]}
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 28, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Sunday, June 28, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
