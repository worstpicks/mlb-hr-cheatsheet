#!/usr/bin/env python3
"""Build 2026-06-22 sheet from imported CSVs and user prop list."""
...
DATE = "2026-06-22"
OUT = ROOT / "build-sheet-2026-06-22.py"
BUM_RISK_MIN = 0.95
...
ALIASES = {
    ...
    "Nate Eton": "Nate Eaton",
    "Daniel Schneemann": "Daniel Schneemann",
...
def main() -> int:
    ...
    for name in selected:
        ...
        if name in BATTER_GAME_OVERRIDES:
    ...
    lines.extend(["}", "", "BUM_RISK_MIN = 0.95", "", "BUM_PITCHERS = {"])
