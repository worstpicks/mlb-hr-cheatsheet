#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-16. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-15.html"
SHEET_DATE = "2026-06-16"

spec = importlib.util.spec_from_file_location("build0616", ROOT / "build-sheet-2026-06-16.py")
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 16, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Tuesday, June 16, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
