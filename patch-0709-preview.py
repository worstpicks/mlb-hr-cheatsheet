#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-09. Does not commit or push."""
...
SHEET_DATE = "2026-07-09"

spec = importlib.util.spec_from_file_location("build0709", ROOT / "build-sheet-2026-07-09.py")
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 9, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Thursday, July 9, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
