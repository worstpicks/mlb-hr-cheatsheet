#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-26. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-25.html"
SHEET_DATE = "2026-07-26"

spec = importlib.util.spec_from_file_location("build0726", ROOT / "build-sheet-2026-07-26.py")
...
def update_manifest():
    ...
    if "2026-07-25" in old or (ARCHIVE_PREVIOUS.is_file()):
        old["2026-07-25"] = {
            "date": "2026-07-25",
            "label": "July 25, 2026",
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 26, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-07-25",
        "2026-07-24",
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Sunday, July 26, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
