#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-25. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-24.html"
SHEET_DATE = "2026-07-25"

spec = importlib.util.spec_from_file_location("build0725", ROOT / "build-sheet-2026-07-25.py")
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 25, 2026 — current slate", "href": "index.html"},
    ]
    for date in [
        "2026-07-24",
        "2026-07-22",
