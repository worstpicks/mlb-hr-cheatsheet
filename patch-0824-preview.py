#!/usr/bin/env python3
"""Patch preview sheet to 2026-08-24. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0824", ROOT / "build-sheet-2026-08-24.py")
