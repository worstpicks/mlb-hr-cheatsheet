#!/usr/bin/env python3
"""Deep content audit for the 2026-08-24 sheet: prop coverage, markers, bums, staleness."""
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ...
    ('Joc Pederson', ANY, ""),
    ('Justin Foscue', ANY, ""),
    ('Moises Ballesteros', ANY, GEM),
    ('Zach Neto', ANY, STAR),
    ('Christian Moore', ANY, ""),
    ('Jo Adell', ANY, GEM),
    ('Petey Halpin', ANY, ""),
    ('Cal Raleigh', ANY, ""),
    ('Brock Rodden', ANY, GEM),
    ('Patrick Wisdom', ANY, ""),
    ('Julio Rodriguez', ANY, ""),
    ('Alec Bohm', ANY, ""),
    ('Bryce Harper', ANY, ""),
...
EXPECTED_BUMS = {"Jeffrey Springs", "Ryan Feltner", "Zebby Matthews"}

# Every game carries two pitcher segments. Jose Urquidy and Carson Whisenhunt are
# missing from PropFinder's HR-risk export, so their headers render real measured
# rates rather than a risk score.
