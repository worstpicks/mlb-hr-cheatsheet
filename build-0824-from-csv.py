#!/usr/bin/env python3
"""Build 2026-08-24 sheet from imported CSVs and user prop list."""
...
DATE = "2026-08-24"
OUT = ROOT / "build-sheet-2026-08-24.py"
BUM_RISK_MIN = 0.95

# Arms whose HR-risk row was carried from an earlier slate by
# build-synthetic-0824-matchups.py. Nothing is carried today: every arm the sheet
...
ALIASES = {
    # prop-list typos
    "Adley Rustchman": "Adley Rutschman",
