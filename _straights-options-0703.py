#!/usr/bin/env python3
"""List all straight options for 2026-07-03."""
...
g: dict = {"__file__": str(ROOT / "patch-0703-preview.py"), "__name__": "__main__"}
exec(compile(cut + "\n", "patch-0703-preview.py", "exec"), g)
...
print("=" * 100)
print("CURRENT STRAIGHTS ON SHEET (7/3)")
print("=" * 100)
