...
ROOT = Path(".")
spec = importlib.util.spec_from_file_location("b", "build-sheet-2026-08-11.py")
b = importlib.util.module_from_spec(spec)
spec.loader.exec_module(b)
risk = load_pitcher_risk(ROOT / "data/hr-targets-overall-2026-08-11.csv")
rows = []
for g in enrich_games_list(b.games, "2026-08-11"):
