#!/usr/bin/env python3
"""Patch index.html (and preview copy) for 2026-05-16 slate — local only."""
import re
...
MANIFEST_FB = (
    ...
    '{"version":1,"sheets":[{"date":"2026-05-16","label":"May 16, 2026 \\u2014 current slate","href":"/index.html"},'
...
def replace_summary_list(text, heading, inner):
    ...
    pat = (
        rf'(<h3>{re.escape(heading)}</h3>\s*<div class="summary-list">)(.*?)(</div>)'
    )
