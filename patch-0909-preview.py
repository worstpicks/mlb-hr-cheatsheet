#!/usr/bin/env python3
"""Patch preview sheet to 2026-09-09. Does not commit or push."""
...
spec = importlib.util.spec_from_file_location("build0909", ROOT / "build-sheet-2026-09-09.py")
...
def _ensure_research_json() -> None:
    ...
    if path.is_file():
        return
    print(f"research JSON missing for {SHEET_DATE} — building it before reading lineups")
...
# Score gates below are percentile-matched to the pre-2026-09-09 scale. The rating
