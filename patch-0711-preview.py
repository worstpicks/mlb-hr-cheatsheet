#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-11. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-07-10.html"
SHEET_DATE = "2026-07-11"

spec = importlib.util.spec_from_file_location("build0711", ROOT / "build-sheet-2026-07-11.py")
...
# 7/11 Favorite 3-leg: attack-ranked user ⭐ only (thin 7-game board).
_fav3_pick_order = [
    "JJ Bleday",
    "Max Muncy",
    "Yordan Alvarez",
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 11, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Saturday, July 11, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
