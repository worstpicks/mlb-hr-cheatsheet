#!/usr/bin/env python3
"""Quick audit for 2026-07-10 sheet before push."""
...
if not (ROOT / "preview" / "data" / "research-2026-07-10.json").exists():
    errors.append("missing preview/data/research-2026-07-10.json")
if not (ROOT / "preview" / "data" / "park-factors-2026-07-10.json").exists():
    errors.append("missing preview/data/park-factors-2026-07-10.json")
...
if manifest["sheets"][0]["date"] != "2026-07-10":
    errors.append("manifest current slate not 2026-07-10")

if errors:
    print("FAIL audit-0710:")
    for e in errors:
        print(" ", e)
    raise SystemExit(1)

print(
    f"OK audit-0710 — sheet-date, {EXPECTED_GAMES}/{EXPECTED_GAMES} park headers, "
