#!/usr/bin/env python3
"""List all Straight of the Day options for 2026-07-23."""
...
g: dict = {"__file__": str(ROOT / "patch-0723-preview.py"), "__name__": "__main__"}
exec(compile(cut + "\n", "patch-0723-preview.py", "exec"), g)
...
print("=" * 110)
print("CURRENT STRAIGHTS ON SHEET (7/23)")
print("=" * 110)
