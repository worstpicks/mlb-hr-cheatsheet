#!/usr/bin/env python3
"""Deep content audit for the 2026-09-07 sheet: prop coverage, markers, bums, staleness."""
...
GAMECOUNT = 11
WEEKDAY = "Monday"
DATE_TEXT = "September 7, 2026"

# (name, game override, marker), generated from build-0907-from-csv.py RAW_PROPS so
# the audit cannot drift from what was actually built. Two Max Muncys again today
# (Oakland's RHB, not in their posted lineup, and the Dodgers' LHB batting fourth);
# the listed prop is the Dodgers one, so it carries its game.
ANY = None
...
RESOLVED: dict[str, str] = {
    # The owner's list dropped a letter; the build resolves a one-character
    # difference against the export rather than dropping the prop.
    "Alejanro Kirk": "Alejandro Kirk",
}
...
SUPERSEDED_PROBABLES: list[str] = ["Bobby Miller"]  # exported arm; the Dodgers start Emmet Sheehan
