#!/usr/bin/env python3
"""Synthesize the hr-matchups game PropFinder did not export for 2026-09-07.
...
GAPS: dict[str, dict] = {
    # 2026-09-07: nothing to fill. All 22 arms on the 11-game slate shipped a real
    # PropFinder export with a full batter block, so no lineup is reconstructed and
    # no form is carried from another day.
}
