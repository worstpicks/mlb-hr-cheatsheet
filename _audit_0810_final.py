#!/usr/bin/env python3
"""Final local audit for 2026-08-10 (do not push)."""
...
def main() -> int:
    ...
    if "Monday, August 10, 2026" not in html:
        fail("hero must be Monday, August 10, 2026")
    ...
    if "August 10, 2026 — current slate" not in html:
        fail("manifest missing August 10 current slate")
