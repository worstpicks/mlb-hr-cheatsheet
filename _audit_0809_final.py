#!/usr/bin/env python3
"""Final local audit for 2026-08-09 (do not push)."""
...
def main() -> int:
    ...
    if "Sunday, August 9, 2026" not in html:
        fail("hero must be Sunday, August 9, 2026")
    ...
    if "August 9, 2026 — current slate" not in html:
        fail("manifest missing August 9 current slate")
    ...
    if not m or int(m.group(1)) != 97:
        fail(f"expected 97 props, got {m.group(0) if m else None}")
