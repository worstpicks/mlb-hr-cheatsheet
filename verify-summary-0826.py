...
patch_globals: dict = {"__file__": str(ROOT / "patch-0826-preview.py"), "__name__": "__main__"}
cut = (ROOT / "patch-0826-preview.py").read_text(encoding="utf-8").split("THREE_LEG_HR =")[0]
exec(compile(cut + "\n", "patch-0826-preview.py", "exec"), patch_globals)
...
if errors:
    print("FAIL verify-summary-0826:")
    for e in errors:
        print(f"  {e}")
    raise SystemExit(1)

print("OK verify-summary-0826")
