#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-19. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-18.html"
SHEET_DATE = "2026-06-19"

spec = importlib.util.spec_from_file_location("build0619", ROOT / "build-sheet-2026-06-19.py")
...
# 6/19 judgment: O0.5 + O1.5 from best attack lanes after initial pool pick.
...
# 6/19 Favorite 3-leg: all user ⭐ favorites on this slate.
_fav3_pick_order = [
    "Colt Keith",
    "Ben Rice",
    "Matt McLain",
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 19, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Friday, June 19, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
