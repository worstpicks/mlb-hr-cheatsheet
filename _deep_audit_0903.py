#!/usr/bin/env python3
"""Deep content audit for the 2026-09-03 sheet: prop coverage, markers, bums, staleness."""
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ...
    ('Graham Pauley', ANY, GEM),
    ('Kyle Stowers', ANY, GEM),
    ('Brandon Nimmo', ANY, GEM),
    ('Corey Seager', ANY, STAR),
    ('Elias Diaz', ANY, ""),
    ('Jake Burger', ANY, STAR),
    ('Ezequiel Duran', ANY, GEM),
    ('Justin Foscue', ANY, ""),
    ('Yandy Diaz', ANY, STAR),
    ('Junior Caminero', ANY, GEM),
    ('Jonathan Aranda', ANY, ""),
...
EXPECTED_BUMS = {"Luis Castillo"}

# Every arm on this slate has its own same-day HR-risk row, so every header carries
# two real splits and nothing falls back.
