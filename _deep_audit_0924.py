#!/usr/bin/env python3
"""Deep content audit for the 2026-09-24 sheet: prop coverage, markers, bums, staleness."""
...
# (name, game override, marker), generated from build-0924-from-csv.py RAW_PROPS so
...
EXPECTED_BUMS = {'Mason Barnett', 'Brady Singer'}
...
SUPERSEDED_PROBABLES: list[str] = ["Daniel Espino"]  # opener; Joey Cantillo is the bulk arm (PRIM)
...
def main() -> int:
    ...
    # 2026-09-24 rebalance the model ended in a clamp at 58 and a third of every
