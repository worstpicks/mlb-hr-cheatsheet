#!/usr/bin/env python3
"""Build 2026-06-03 sheet from imported CSVs and user prop list."""
...
DATE = "2026-06-03"
OUT = ROOT / "build-sheet-2026-06-03.py"
