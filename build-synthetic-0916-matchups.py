#!/usr/bin/env python3
"""Fill hr-matchups PropFinder did not export for 2026-09-16.

  Nothing to fill. All 15 games shipped both arms with real batter tables (30 files,
  checked row by row); this run exists to prove it rather than to assume it.
"""
...
GAPS: dict[str, dict] = {
    # Nothing to fill: all 30 exports carry a real batter table.
}
