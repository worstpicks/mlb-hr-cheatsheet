#!/usr/bin/env python3
"""Synthesize the one hr-matchups game PropFinder did not export for 2026-08-16.

BOS @ PIT shipped Sandoval but not Lake Bachar, who is the slate's fourth bum at
0.95 HR risk. Without this the three listed Red Sox bats (Yoshida, Abreu, Duran)
would drop and the game would render one-sided.

Everything here is real slate data, reassembled:
  - lineups, handedness and ZONE come from zone-matchups-2026-08-16.csv
  - the pitcher Season/vsLHB/vsRHB block comes from the pitcher-summary exports
  - batter recent-form is carried from each hitter's most recent matchup export,
    since form is pitcher-independent

ODDS are left N/A: no 8/16 price was exported for this pitcher.
"""
