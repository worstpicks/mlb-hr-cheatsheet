#!/usr/bin/env python3
"""Fill hr-matchups PropFinder did not export for 2026-09-15.

  Nothing to fill. All 15 games shipped both arms with real batter tables; this run
  exists to prove it rather than to assume it.
"""
