#!/usr/bin/env python3
"""Final local audit for 2026-08-16 (do not push)."""
...
def main() -> int:
    ...
    arch = ROOT / "preview" / "archive" / "2026-08-15.html"
    if not arch.exists():
        fail("8/15 archive missing")
    elif 'content="2026-08-15"' not in arch.read_text(encoding="utf-8"):
