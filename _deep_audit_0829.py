#!/usr/bin/env python3
"""Deep content audit for the 2026-08-29 sheet: prop coverage, markers, bums, staleness."""
...
USER_PROPS: list[tuple[str, str | None, str]] = [
    ('Paul Goldschmidt', 'BOS @ NYY (G1)', ""),
    ('Trent Grisham', 'BOS @ NYY (G2)', GEM),
    ('Ben Rice', 'BOS @ NYY (G1)', ""),
    ('Heliot Ramos', 'BOS @ NYY (G1)', ""),
    ('Jahmai Jones', 'BOS @ NYY (G1)', ""),
    ('Eduardo Valencia', ANY, GEM),
    ('Kevin McGonigle', ANY, ""),
    ('Max Muncy', 'LAD @ DET', GEM),
    ('Hunter Feduccia', ANY, ""),
    ('Shohei Ohtani', ANY, ""),
    ...
    ('Troy Johnston', ANY, ""),
    ('TJ Rumfield', ANY, ""),
    ('Spencer Jones', 'BOS @ NYY (G2)', STAR),
    ('Ben Rice', 'BOS @ NYY (G2)', GEM),
    ('Jahmai Jones', 'BOS @ NYY (G2)', GEM),
    ('Willson Contreras', 'BOS @ NYY (G2)', ""),
...
EXPECTED_BUMS = {"Ryan Johnson"}

# Every game carries two pitcher segments. Five arms are missing from PropFinder's
# HR-risk export and render real measured rates; Lake Bachar has no split book at
# all, so his segment shows his season BAA, labelled as such.
...
SUPERSEDED_PROBABLES: list[str] = ["Carmen Mlodzinski", "Cristian Javier"]  # replaced by Bachar and Sousa
