#!/usr/bin/env python3
"""Patch preview sheet to 2026-07-01. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-30.html"
SHEET_DATE = "2026-07-01"

spec = importlib.util.spec_from_file_location("build0701", ROOT / "build-sheet-2026-07-01.py")
...
# 7/1 judgment: lock Caminero O1.5 vs Lugo bum; Ty France O0.5 vs Rea (+1.17 split, +47% park).
_caminero_o15 = rows_by_plain_early.get("Junior Caminero")
_france_o05 = rows_by_plain_early.get("Ty France")
if _caminero_o15:
    straight_o15 = _caminero_o15
if (
    _france_o05
    and straight_o15
    and _france_o05["game_key"] != straight_o15["game_key"]
):
    straight_o05 = _france_o05
straight_names = {straight_o05["name"], straight_o15["name"]}
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "July 1, 2026 — current slate", "href": "index.html"},
        {"date": "2026-06-30", "label": "June 30, 2026", "href": "archive/2026-06-30.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Wednesday, July 1, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
