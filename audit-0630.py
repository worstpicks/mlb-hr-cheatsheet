#!/usr/bin/env python3
"""Quick audit for 2026-06-30 sheet before push."""
...
EXPECTED_GAMES = 15
EXPECTED_PROPS = 85
ZONE_MIN = min(EXPECTED_PROPS, max(45, EXPECTED_PROPS - 15))

if 'sheet-date" content="2026-06-30"' not in html:
...
if not (ROOT / "preview" / "data" / "research-2026-06-30.json").exists():
    errors.append("missing preview/data/research-2026-06-30.json")
if not (ROOT / "preview" / "data" / "park-factors-2026-06-30.json").exists():
    errors.append("missing preview/data/park-factors-2026-06-30.json")
...
spec = importlib.util.spec_from_file_location("b", ROOT / "build-sheet-2026-06-30.py")
...
if manifest["sheets"][0]["date"] != "2026-06-30":
    errors.append("manifest current slate not 2026-06-30")
if not (ROOT / "preview" / "archive" / "2026-06-29.html").exists():
    errors.append("missing archive 2026-06-29.html")

if errors:
    print("FAIL audit-0630:")
    for e in errors:
        print(" ", e)
    raise SystemExit(1)

print(
    f"OK audit-0630 — sheet-date, {EXPECTED_GAMES}/{EXPECTED_GAMES} park headers, "
