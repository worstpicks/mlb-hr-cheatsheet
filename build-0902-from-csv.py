#!/usr/bin/env python3
"""Build 2026-09-02 sheet from imported CSVs and user prop list."""
...
DATE = "2026-09-02"
OUT = ROOT / "build-sheet-2026-09-02.py"
BUM_RISK_MIN = 0.95

# Arms whose HR-risk row was carried from an earlier slate by
# build-synthetic-0902-matchups.py. Nothing is carried today: every arm the sheet
...
ALIASES = {
    # prop-list typos
    "Andrews Chaparro": "Andres Chaparro",
    "Lamonte Wade Jr.": "LaMonte Wade Jr.",
