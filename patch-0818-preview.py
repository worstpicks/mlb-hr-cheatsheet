#!/usr/bin/env python3
"""Patch preview sheet to 2026-08-18. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-08-17.html"
SHEET_DATE = "2026-08-18"

spec = importlib.util.spec_from_file_location("build0818", ROOT / "build-sheet-2026-08-18.py")
