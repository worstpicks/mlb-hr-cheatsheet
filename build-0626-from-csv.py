#!/usr/bin/env python3
"""Build 2026-06-26 sheet from imported CSVs and user prop list."""
...
DATE = "2026-06-26"
OUT = ROOT / "build-sheet-2026-06-26.py"
BUM_RISK_MIN = 0.95
...
ALIASES = {
    ...
    "Fernado Tatis Jr.": "Fernando Tatis Jr.",
    "Fernando Tatis Jr": "Fernando Tatis Jr.",
    "Max Schnuemann": "Max Schuemann",
    "Tj Rumfield": "TJ Rumfield",
    "Mike Yastzemski": "Mike Yastrzemski",
    "Willson Contreras": "Willson Contreras",
    "Julio Rodriguez": "Julio Rodriguez",
    "Khalil Watson": "Kahlil Watson",
}

# PropFinder zone export only — not in hr-matchups lineup for 6/26.
...
def parse_prop_label(raw: str) -> tuple[str, bool, bool, str | None]:
    ...
    if m:
        clean = "Max Muncy"
        game_override = "LAD @ SD" if m.group(1).upper() == "LAD" else "ATH @ LAA"
