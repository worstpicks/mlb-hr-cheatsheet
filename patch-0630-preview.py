#!/usr/bin/env python3
"""Patch preview sheet to 2026-06-30. Does not commit or push."""
...
ARCHIVE_PREVIOUS = ROOT / "preview" / "archive" / "2026-06-29.html"
SHEET_DATE = "2026-06-30"

spec = importlib.util.spec_from_file_location("build0630", ROOT / "build-sheet-2026-06-30.py")
...
# 6/29 judgment: Riley Greene is the clearest O0.5 bum-lane vs Weathers (+1.32 risk).
_greene_o05 = rows_by_plain_early.get("Riley Greene")
if (
    _greene_o05
    and straight_o05
    and straight_o15
    and straight_o15["game_key"] != _greene_o05["game_key"]
    and _greene_o05["risk"] >= 1.0
):
    straight_o05 = _greene_o05
    straight_names = {straight_o05["name"], straight_o15["name"]}
...
def update_manifest():
    ...
    ordered = [
        {"date": SHEET_DATE, "label": "June 30, 2026 — current slate", "href": "index.html"},
...
def patch_preview(manifest):
    ...
    text = re.sub(
        ...
        "<p>Tuesday, June 30, 2026 — Worst Pickz HR cheat sheet",
        text,
        count=1,
    )
