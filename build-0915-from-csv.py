#!/usr/bin/env python3
"""Build 2026-09-15 sheet from imported CSVs and user prop list."""
...
DATE = "2026-09-15"
OUT = ROOT / "build-sheet-2026-09-15.py"
BUM_RISK_MIN = 0.95

# Arms whose HR-risk row was carried from an earlier slate by
# build-synthetic-0915-matchups.py. Nothing is carried today: every arm the sheet
...
def mlb_hand_lane(full_name: str) -> dict | None:
    ...
    try:
        ...
        if len(people) == 1:
            ...
            if found.get("vl") and found.get("vr"):
                out = found
    except Exception:
        out = None
...
def main() -> int:
    ...
    # ships the prop list's typos: 2026-09-15 arrived with "Alejandro kirk". When the
    ...
    def canonical_case(name: str) -> str:
        ...
        "Alejandro kirk", 2026-09-15 sent "Alejanro Kirk", which matched nothing at
