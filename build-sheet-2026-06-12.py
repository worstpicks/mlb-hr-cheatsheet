...
games = [
    ...
    {
        "title": "COL @ ATH - Sean Sullivan (L, COL) vs Gage Jump (L, ATH)",
        ...
        "rows": [
            row("Nick Kurtz", "L", "+168", 98, "🚀 ⭐ 🌕 💣", ["vs Sullivan"], """Worst Pickz Favorite. 4 HR, 3 near-HR, 101.5 mph EV. Sullivan split/risk data unavailable. limited split/risk sample.""", blast="high"),
            row("Shea Langeliers", "R", "+154", 83, "🌕 💣", ["vs Sullivan"], """2 HR, 2 near-HR, 93.4 mph EV. Sullivan split/risk data unavailable. limited split/risk sample.""", blast="high"),
            row("Henry Bolte", "R", "+425", 82, "🚀 💎", ["vs Sullivan"], """Worst Pickz Hidden Gem. 1 HR, 1 near-HR, 104.9 mph EV. Sullivan split/risk data unavailable. limited split/risk sample.""", blast="good"),
            row("Zack Gelof", "R", "+310", 74, "", ["vs Sullivan"], """1 HR, 1 near-HR, 92.1 mph EV. Sullivan split/risk data unavailable. limited split/risk sample.""", blast="good"),
            row("Colby Thomas", "R", "+270", 77, "", ["vs Sullivan"], """1 HR, 1 near-HR, 95.4 mph EV. Sullivan split/risk data unavailable. limited split/risk sample.""", blast="good"),
