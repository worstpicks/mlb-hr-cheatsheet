#!/usr/bin/env python3
"""Build 2026-07-26 sheet from imported CSVs and user prop list."""
...
DATE = "2026-07-26"
OUT = ROOT / "build-sheet-2026-07-26.py"
BUM_RISK_MIN = 0.95
...
ALIASES = {
    ...
    "Pete Crow-Armstrong": "Pete Crow-Armstrong",
    "Rtan waldschmnidt": "Ryan Waldschmidt",
...
# No DH on 2026-07-26 — use PropFinder-derived games as-is.
